  ...
  <div class="comment-item">
    ...
    <div class="comment-info">
      ...
      <div class="reply-info" v-if="commentData.showReply">
        <PostComment :articleId="articleId" :avatarWidth="30" :userId="currentUserId" :showInsertImg="false" :pCommentId="pCommentId" :replyUserId="replyUserId" @postCommentFinsh="postCommentFinsh" :placeholderInfo="placeholderInfo"></PostComment>
      </div>
    </div>
  </div>
</template>
