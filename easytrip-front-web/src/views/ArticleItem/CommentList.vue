<template>
  <div class="comment-body">
        ...
        <div class="comment-form-panel">
            <PostComment :avatarWidth="50" :userId="currentUserInfo.userId" :showInsertImg="currentUserInfo.userId!=null" :articleId="articleId" :pCommentId="0"  @postCommentFinsh="postCommentFinsh"></PostComment>
        </div>
        <div class="comment-list">
            ...
            <template #default="{data}">
                <CommentListItem :articleId="articleId" :commentData ="data" :articleUserId="articleUserId" :currentUserId="currentUserInfo.userId" @hiddenAllReply="hiddenAllReplyHandler" @reloadData="reloadData"></CommentListItem>
            </template>
            </DataList>
        </div>
  </div>
